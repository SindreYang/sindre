...
class DGCNN(nn.Module):
    def __init__(
        ...
        if use_bn:
            ...
            self.conv1 = nn.Sequential(nn.Conv2d(in_channels*2, 64, kernel_size=1, bias=False), self.bn1, nn.LeakyReLU(negative_slope=0.2))
            ...
            self.conv1 = nn.Sequential(nn.Conv2d(in_channels*2, 64, kernel_size=1, bias=False), nn.LeakyReLU(negative_slope=0.2))
